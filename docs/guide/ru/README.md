Расширение AuthClient для Yii
=============================

Данное расширение добавляет клиенты [OAuth2](https://oauth.net/2/) и [OpenID Connect](https://openid.net/connect/)
для Yii framework 3.0.
